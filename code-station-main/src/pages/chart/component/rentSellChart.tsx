    ...
    function getPie3D(pieData, internalDiameterRatio) {
      ...
      const option = {
        ...
        legend: {
          show: true,
          itemGap: 15,
          // data: ['10%以内:25%', '10%-20%:25%','20%-30%:25%','30%以上:25%'],
          orient: 'vertical',
          right: '10px',
          left: '10px',
          top: '50px',
          ...
          data: [
            {
              ...
              textStyle: {
                width: '10',
                color: '#25C9FF',
                textShadowOffsetX: 200,
              },
              itemStyle: { color: '#23C0F4' },
            },
            {
              name: '出售',
              textStyle: { width: '20', color: '#07FFDA' },
              itemStyle: { color: '#07FFDA' },
            },
            // {
            //   name: '累计疲劳',
            //   textStyle: { width: '20', color: '#FFAF36' },
            //   itemStyle: { color: '#07FFDA' },
            // },
          ],
          formatter(name) {
